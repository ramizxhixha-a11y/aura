...
const HEAD03 = '// [GÉNOME DE PAIRE · 17/09/2026] VERSION 20260917e';   // [1b-b · 15/09] 03 relivré (heatmap EV/RE seulement) ; en-tête PHASE 1 20260912c en 2e ligne ; 04/09b3 restent au GEL BOOT 20260911c
...
(async () => {
  ...
  /* ───── statique ───── */
  await T('syntaxe : 03, 04, 09b3 compilent + en-têtes VERSION ' + VER03 + ' (03 : GÉNOME DE PAIRE 20260917e)', () => {
