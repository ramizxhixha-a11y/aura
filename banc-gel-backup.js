...
const HEAD03 = '// [PHASE 1 · 12/09/2026] VERSION 20260912c';   // [PHASE 1 · 12/09] 03 relivré (vote par paire) : son en-tête porte la phase 1 ; 04/09b3 restent au GEL BOOT 20260911c
...
(async () => {
  ...
  /* ───── statique ───── */
  await T('syntaxe : 03, 04, 09b3 compilent + en-têtes VERSION ' + VER03 + ' (03 : PHASE 1 20260912c)', () => {
