...
const VER = { 'guardian-core.js':'// [GEL BOOT · 12/09/2026] VERSION 20260912b', 'guardian-embed.js':'20260911a', 'js/00-backup-state.js':'20260911a', 'js/08-learning-history-render.js':'// [MÉMOIRE DES CHEMINS · 22/09/2026] VERSION 20260922a', 'js/09b1-build-snapshot.js':'// [GAIN APPRIS · 23/09/2026] VERSION 20260923a', 'js/09b2-save-load.js':'// [GAIN APPRIS · 23/09/2026] VERSION 20260923a', 'js/09k-init.js':'20260911a' };
let pass = 0, fail = 0;
