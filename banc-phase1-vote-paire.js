...
T('en-têtes : 02/03/08/12 « [PHASE 1 · 12/09/2026] VERSION ' + TOK + ' », 10f « ▓▓▓ VERSION ' + TOK + ' ▓▓▓ »', () => {
  for (const [f, s] of [[F02, s02], [F03, s03], [F08, s08], [F12, s12]]) assert.ok(s.startsWith('// [PHASE 1 · 12/09/2026] VERSION ' + TOK), f);
