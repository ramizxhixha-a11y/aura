...
T('en-têtes : 03/12 « [PHASE 1 · 12/09/2026] VERSION 20260912c », 02/08 relivrés par 1b-a « [1b-a · 14/09/2026] VERSION 20260914a », 10f « ▓▓▓ VERSION 20260917b ▓▓▓ »', () => {
  ...
  assert.ok(s08.startsWith('// [JOURNAL DES ÉVÉNEMENTS · 20/09/2026] VERSION 20260920b') && s08.split('\n').slice(0, 6).some(l => l.startsWith('// [1b-a · 14/09/2026] VERSION 20260914a')), F08);   // [1b-b] 08 relivré, en-tête 1b-a en 2e ligne
  assert.ok(s02.startsWith('// [JOURNAL DES ÉVÉNEMENTS · 20/09/2026] VERSION 20260920b') && s02.split('\n').slice(0, 7).some(l => l.startsWith('// [1b-a · 14/09/2026] VERSION 20260914a')), F02);   // [SONDE RÉSEAU] 02 relivré, en-tête 1b-a en 2e ligne
