...
T('en-têtes : 03/12 « [PHASE 1 · 12/09/2026] VERSION 20260912c », 02/08 relivrés par 1b-a « [1b-a · 14/09/2026] VERSION 20260914a », 10f « ▓▓▓ VERSION 20260917b ▓▓▓ »', () => {
  ...
  assert.ok(s02.startsWith('// [MÉMOIRE DES CHEMINS · 22/09/2026] VERSION 20260922a') && s02.split('\n').slice(0, 9).some(l => l.startsWith('// [1b-a · 14/09/2026] VERSION 20260914a')), F02);   // [SONDE RÉSEAU] 02 relivré, en-tête 1b-a en 2e ligne
  assert.ok(s10f.startsWith('// ▓▓▓ VERSION 20260922a ▓▓▓'));   // 10f livré au hotfix 1b-a (b), non retouché depuis
});
