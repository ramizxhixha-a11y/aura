...
T('HTML : 78 ressources au token 20260906g ([P7] +10e7), aucune au token précédent, DOC_V = 20260906g', () => { assert.strictEqual((html.match(/\?v=20260906g/g) || []).length, 78); assert.ok(!html.includes('20260906f')); assert.ok(html.includes("var DOC_V = '20260906g';")); });
