...
T('HTML : 77 ressources au token 20260906f, aucune au token précédent, DOC_V = 20260906f', () => { assert.strictEqual((html.match(/\?v=20260906f/g) || []).length, 77); assert.ok(!html.includes('20260906e')); assert.ok(html.includes("var DOC_V = '20260906f';")); });
