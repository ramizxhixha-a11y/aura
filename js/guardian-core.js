...
function drvGetToken(interactive){
  return new Promise(async(resolve,reject)=>{
    ...
    try {
      ...
      // prompt '' : Google réutilise l'autorisation existante si possible (silencieux),
      // et n'affiche l'écran QUE s'il le faut vraiment. Évite de redemander à chaque fois.
