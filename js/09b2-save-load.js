...
async function loadState() {
  ...
  try {
    ...
    ['_lastEvolutionAt', '_lastAutoRevigorTs', '_lastDreamAt'].forEach(function (k) {   // [REDÉMARRAGE · 26/09/2026]
      var v = Number(snap[k]);
      ...
      // trois partaient à CHAQUE rechargement (capture Rams 26/09 22:09). Zéro enregistré = jamais arrivé : rien n'est retenu.
