...
async function loadState() {
  ...
  try {
    ...
    if (snap.fundingPaid != null)    S.fundingPaid    = snap.fundingPaid;
    if (snap._lastFundingTs != null) S._lastFundingTs = snap._lastFundingTs;
