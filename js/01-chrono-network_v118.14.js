/* ═══════════════════════════════════════════════════════════
   ...
   v118.14 changements :
   - Utilise le 3ème paramètre 'type' de showToast (couleurs natives)
   - sim   → type 'info' (bleu)
   - paperReal → type 'win'  (vert)
   - real  → type 'loss' (rouge)
   - Texte propre : "Activation Mode XXX"
   
   Si tu vois encore "Mode: ..." dans le toast → l'upload n'a pas pris.
   Vérification : la ligne ~437 doit dire showToast(msg, 2500, type)
   ═══════════════════════════════════════════════════════════ */
